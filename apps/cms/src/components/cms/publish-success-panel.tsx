      ...
      <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
        ...
        {otherSiteLabel && onPublishOther && (
          <button
            ...
            className="rounded-[10px] border border-border bg-card px-4 py-2.5 text-[13.5px] font-semibold text-ink transition-colors hover:border-brand hover:text-brand disabled:cursor-default disabled:opacity-60"
          >
